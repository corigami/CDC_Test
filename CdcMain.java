  ...
  implements ActionListener, KeyListener
{
  ...
  Vector sectionMissed = new Vector(1, 1);
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    else if (e.getActionCommand().equals("SAVE"))
    {
      ...
      Io.printToText("set" + set + "QandA.txt", QSET);
      clearEdit();
    }
    ...
    throws Exception
  {
    ...
    jTextField2.setActionCommand("GoNum");
    ...
    jLabel18.setText("Please report any errors, bugs, or suggestions to corey.willinger@gmail.com");
    ...
    jPanel2.add(jLabel18,   new XYConstraints(22, 313, 441, 41));
    jPanel2.add(jLabel19,  new XYConstraints(265, 347, 127, 24));
...
// jPanel2.setVisible(false);
  ...
  public void getList(String qfile, String logFile)
  {
    number = 0;
    ...
    //  sectionMissed = Io.getSections(qfile,logFile);
    total = qList.size();
  ...
  public void outputResults()
  {
    ...
    /*  for(int x =0;x<missedQuestions.size();x++)
      {
        tempString = ((QInfo)missedQuestions.elementAt(x)).getSection();
        for(int y = 0;y < sectionMissed.size();y++)
        if(tempString.equalsIgnoreCase(((Section)sectionMissed.elementAt(y)).getSection()))
        {
          tempInt = ((Section)sectionMissed.elementAt(y)).getMissed()+1;
          ((Section)sectionMissed.elementAt(y)).setMissed(tempInt);
        }
      }
     Io.outputSectionMissed(sectionMissed,logFile);*/qTemp = new QInfo();
